...
EM FX NDF mean-reversion signal using DCC-GARCH dynamic correlations.
...
class EMDCCStrategy(FXStrategy):
    """DCC-correlation mean-reversion signal for EM FX NDFs.
    ...
    ... }
    >>> strategy = EMDCCStrategy(instruments=["Brazil", "Columbia", "Chile"])
